...
class YetAnotherWeatherCard extends HTMLElement {
  ...
  renderRadarSection() {
    return '<div class="radar-section">' +
           '<div class="section-header">NWS Radar Information</div>' +
           '<div class="radar-display" style="height: ' + this._config.radar_height + 'px;">' +
           '<div class="radar-placeholder">' +
           '<div class="radar-message">NEXRAD Radar Display</div>' +
           '<div class="radar-info">Visit radar.weather.gov for live radar</div>' +
           '<div class="radar-location">Location: ' + this._weatherData.coordinates.latitude.toFixed(2) + ', ' + this._weatherData.coordinates.longitude.toFixed(2) + '</div>' +
           '</div>' +
           '</div>' +
           '</div>';
  }
